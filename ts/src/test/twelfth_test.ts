...
import { linearSolution } from '../main_problem/linear_solution';
...
export default function test(): void {
    console.log("======> TWELFTH TEST: main problem, linear hypothesis compared to brute force");
    ...
    const tests: Problem[][] = inputs.map(serie => serie.map(input => ({
        ...
        obtainedOutput: linearSolution(input)
    })));
